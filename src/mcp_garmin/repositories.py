...
class GarminRepository:
    ...
    def body_battery_stress_history(
        ...
        result = self._from_garmin(
            DailyBodyBatteryStress.list, end=end, days=days, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def resting_heart_rate(self, end: str | None = None, days: int = 7) -> list[dict]:
        ...
        result = self._from_garmin(
            DailyHeartRate.list, end=end, days=days, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def daily_stress(self, end: str | None = None, period: int = 7) -> list[dict]:
        ...
        result = self._from_garmin(
            DailyStress.list, end=end, period=period, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def training_status_weekly(
        self, end: str | None = None, period: int = 7
    ) -> list[dict]:
        ...
        result = self._from_garmin(
            TrainingReadinessData.list, end=end, period=period, client=client
        )
        return [asdict(entry) for entry in result]

    def training_status_monthly(
        self, end: str | None = None, period: int = 7
    ) -> list[dict]:
    ...
    def morning_training_readiness(self, day: str | None = None) -> dict:
        ...
        result = self._from_garmin(
            MorningTrainingReadinessData.get, day=day, client=client
        )
        return asdict(result) if result is not None else {}
    ...
    def activities(self, limit: int = 20, start: int = 0) -> list[dict]:
        ...
        result = self._from_garmin(
            Activity.list, limit=limit, start=start, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def activity_map(self, activity_id: int) -> dict:
        ...
        result = self._from_garmin(
            Activity.map_details, activity_id=activity_id, client=client
        )
        return asdict(result) if result is not None else {}
    ...
    def fitness_activities(self, end: str | None = None, days: int = 7) -> list[dict]:
        ...
        result = self._from_garmin(
            FitnessActivity.list, end=end, days=days, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def daily_steps(self, end: str | None = None, period: int = 1) -> list[dict]:
        ...
        result = self._from_garmin(
            DailySteps.list, end=end, period=period, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def daily_hydration(self, end: str | None = None, period: int = 1) -> list[dict]:
        ...
        result = self._from_garmin(
            DailyHydration.list, end=end, period=period, client=client
        )
        return [asdict(entry) for entry in result]
    ...
    def hydration_history(self, end: str | None = None, days: int = 7) -> list[dict]:
        ...
        result = self._from_garmin(
            DailyHydration.list, end=end, days=days, client=client
        )
        return [asdict(entry) for entry in result]
